...
function hacerDevolucion() {
    ...
    fetch(BASE_URL+`SistemaGestion/api/prestamo/hacerDevolucion`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
        body: JSON.stringify({clavePrestamo: clavePrestamo})
            ...
            .then(data => {
                if (data.success) {
                    ...
                    Swal.fire({
                        title: 'Error',
                        text: 'La devolución de este prestamo ya se ha realizado',
                        icon: 'error'
                    });
                }
                limpiarFormulario();
            ...
            .catch(error => {
                ...
                Swal.fire({
                    title: 'Error',
                    text: 'Ha ocurrido un error al realizar la devolución',
                    icon: 'error'
                });
            });
}
